export const login_overlay = document.getElementById('login_popup_overlay');
export const login_popup = document.getElementById('login_popup');

const login_close = document.getElementById('btn-cerrar-login_popup');

import { clicked } from "./header";
